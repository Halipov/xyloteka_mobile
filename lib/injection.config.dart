...
import 'app/auth/auth_bloc.dart' as _i9;
import 'app/auth/sign_in_form/bloc/sign_in_form_bloc.dart' as _i8;
import 'data/repository/shared_preference_repository.dart' as _i7;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i7.SharedPreferenceRepository>(
      () => _i7.SharedPreferenceRepository());
  gh.factory<_i8.SignInFormBloc>(
      () => _i8.SignInFormBloc(get<_i5.IAuthFacade>()));
  gh.factory<_i9.AuthBloc>(() => _i9.AuthBloc(
      get<_i5.IAuthFacade>(), get<_i7.SharedPreferenceRepository>()));
  return get;
}
